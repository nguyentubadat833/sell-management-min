            ...
            <div class="flex justify-between gap-2">
              <div>
                <div class="flex gap-2">
                  <NuxtImg :src="getImageProductUrl(product)" class="border dark:border-gray-600 border-1 w-32 overflow-hidden"/>
              ...
              <div class="flex flex-col items-end justify-between">
                <span class="text-orange-600 font-bold tracking-wider">{{ formatNumber(product?.originalPrice) }}</span>
